...
- 'basketCard[]' — Массив с карточками, добавленными в карзину.

Методы класса:
- 'basketScore()' — Метод для подсчета общего колличества товаров в карзине.
...
#### Класс CardModal
 ...
 Отвечает за реализацию модального окна, отображающего подробности о товаре. Позволяет взаимодействовать с товаром (например, добавление в корзину).
...
Отвечает за отображение и управление формой оформления заказа в два этапа: выбор способа оплаты и доставки, а затем ввод контактной информации.
